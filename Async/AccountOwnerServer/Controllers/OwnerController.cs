...
namespace AccountOwnerServer.Controllers
{
    ...
    public class OwnerController : Controller
    {
        ...
        public IActionResult GetAllOwners()
        {
            ...
            {
                _logger.LogError($"Something went wrong inside {nameof(OwnerController.GetAllOwners)} action: {ex.Message}");
        ...
        public async Task<IActionResult> GetAllOwnersAsync()
        {
            ...
            {
                _logger.LogError($"Some error in async method: {ex}");
                return StatusCode(500, "Internal server error");
            }
        }
        ...
        [HttpGet("async/{id}", Name = "OwnerByIdAsync")]
        ...
        public async Task<IActionResult> CreateOwnerAsync([FromBody]Owner owner)
        {
            try
            {
                ...
                return CreatedAtRoute("OwnerByIdAsync", new { id = owner.Id }, owner);
            }
            catch (Exception ex)
            {
                _logger.LogError($"Something went wrong inside CreateOwner action: {ex.Message}");
